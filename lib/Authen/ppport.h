...
----------------------------------------------------------------------
    ...
    lib/Authen/ppport.h -- Perl/Pollution/Portability Version 2.99_05 
   
    Automatically created by Devel::PPPort running under
    perl 5.008005 on Wed Aug 11 06:40:32 2004.
    
    Do NOT edit this file directly! -- Edit PPPort_pm.PL and the
    includes in parts/inc/ instead.
 
    Use 'perldoc lib/Authen/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl lib/Authen/ppport.h [options] [files]
...
This version of F<lib/Authen/ppport.h> is designed to support operation with Perl
...
Tell F<lib/Authen/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<lib/Authen/ppport.h> if you intend to be backward compatible only
up to a certain Perl version.

=head2 --cplusplus

Usually, F<lib/Authen/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<lib/Authen/ppport.h> to leave C++
comments untouched.
...
F<lib/Authen/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<lib/Authen/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl lib/Authen/ppport.h --list-provided

to see which API elements are provided by lib/Authen/ppport.h.
...
also deprecated. You can safely use the supported API, as F<lib/Authen/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<lib/Authen/ppport.h>.
...
Just C<#define> the macro before including C<lib/Authen/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "lib/Authen/ppport.h"
...
F<lib/Authen/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<lib/Authen/ppport.h> is needed for your module,
whether you should make any changes to your code, and whether any
special defines should be used,  F<lib/Authen/ppport.h> can be run as
as Perl script to check your source code. Simply say:

    perl lib/Authen/ppport.h
...
If this version of F<lib/Authen/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<lib/Authen/ppport.h> was generated using the latest version of
...
/* End of File lib/Authen/ppport.h */
